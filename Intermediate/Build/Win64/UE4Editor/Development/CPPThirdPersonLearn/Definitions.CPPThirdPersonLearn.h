...
#define UE_PROJECT_NAME CPPThirdPersonLearn
#define UE_TARGET_NAME CPPThirdPersonLearnEditor
#define UE_MODULE_NAME "CPPThirdPersonLearn"
...
#define CPPTHIRDPERSONLEARN_API DLLEXPORT
